...
public enum GTOreRegistry {
	...
	public static void oreDirectSmelting() {
		...
		GameRegistry.addSmelting(GTMaterialGen.getDust(GTMaterial.Garnierite, 1), GTMaterialGen.getNugget(GTMaterial.Nickel, 3), 0.1F);
		GameRegistry.addSmelting(GTMaterialGen.getDust(GTMaterial.Limonite, 1), GTMaterialGen.get(Items.IRON_NUGGET, 3), 0.1F);
		GameRegistry.addSmelting(GTMaterialGen.getDust(GTMaterial.Magnetite, 1), GTMaterialGen.get(Items.IRON_NUGGET, 3), 0.1F);
		GameRegistry.addSmelting(GTMaterialGen.getDust(GTMaterial.Malachite, 1), GTMaterialGen.getNugget(GTMaterial.Copper, 1), 0.1F);
