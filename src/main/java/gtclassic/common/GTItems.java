...
public class GTItems {
	...
	public static void initItems() {
		...
		isotopicRodThorium = createItem(new GTItemIsotopicRod("thorium", 42));
		isotopicRodPlutonium = createItem(new GTItemIsotopicRod("plutonium", 45));
		nearDepletedRodThorium = createItem(new GTItemDepletedRod("near_depleted", "thorium", 9, 2));
		nearDepletedRodPlutonium = createItem(new GTItemDepletedRod("near_depleted", "plutonium", 12, 2));
		reEnrichedRodThorium = createItem(new GTItemDepletedRod("re_enriched", "thorium", 11, 2));
		reEnrichedRodPlutonium = createItem(new GTItemDepletedRod("re_enriched", "plutonium", 14, 2));
